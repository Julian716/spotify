...
public class SpotifyFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        leabelGenero = new javax.swing.JLabel();
        leabelArtista = new javax.swing.JLabel();
        leabelFollowers = new javax.swing.JLabel();
        ...
        leabelGenero.setText("Genero");

        leabelArtista.setText("Artista");

        leabelFollowers.setText("Followers");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(31, 31, 31)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(leabelFollowers)
                            .addComponent(leabelArtista)
                            .addComponent(labelAlbum)
                            .addComponent(buttonSeleccionar)
                            .addComponent(leabelGenero)
    ...
    private void buttonSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSeleccionarActionPerformed
        try{
            ...
            if(fileChooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION){
                ...
                leabelGenero.setText(album.getGenero());
                leabelArtista.setText(album.getArtista().getNombre());
                labelPerfil.setText(album.getArtista().getPerfil());
                leabelFollowers.setText(album.getArtista().getFollowers() + " Followers");
    ...
    private javax.swing.JLabel leabelArtista;
    private javax.swing.JLabel leabelFollowers;
    private javax.swing.JLabel leabelGenero;
